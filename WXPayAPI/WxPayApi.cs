    ...
    public class WxPayApi
    {
        ...
        */
        public static WxPayData UnifiedOrder(WxPayData inputObj, int timeOut = 6)
        {
            ...
            //inputObj.SetValue("sign", "0CCA72FD266D784838527B75300ED07A");
            string xml = inputObj.ToXml();
        ...
        */
        ...
        {
            var ran = new Random();
            //return string.Format("{0}{1}{2}", WxPayConfig.MCHID, DateTime.Now.ToString("HHmmss"), ran.Next(999));
            //var ran = new Random();
            return string.Format("{0}{1}{2}", WxPayConfig.MCHID, DateTime.Now.Second, ran.Next(999));
        }
        public static string GetOutNewOrder(string OrderNum)
        {
            var ran = new Random();
            //return string.Format("{0}{1}{2}", WxPayConfig.MCHID, DateTime.Now.ToString("HHmmss"), ran.Next(999));
            //var ran = new Random();
            return string.Format("{0}{1}{2}", OrderNum+"abc", DateTime.Now.Millisecond, ran.Next(999));
        }
        /**

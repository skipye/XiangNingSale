...
namespace MvcPager.WebControls.Mvc
{
    public static class PagerHelper
    {
        ...
        public static MvcHtmlString AjaxPager(this HtmlHelper html, IPagedList pagedList, object routeValues, string actionName, string controllerName,
            PagerOptions pagerOptions, AjaxOptions ajaxOptions)
        {
            if (pagedList == null)
                return AjaxPager(html, pagerOptions, null);
            return AjaxPager(html, pagedList.TotalItemCount, pagedList.PageSize, pagedList.CurrentPageIndex, actionName, controllerName, null, pagerOptions, routeValues, ajaxOptions,
                             null);
        }
        #endregion
